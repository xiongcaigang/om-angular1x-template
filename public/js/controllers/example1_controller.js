angular.module(APP_NAME+'.controllers').controller("example1Controller",["$scope","$rootScope", "$stateParams","example1Service","$modal",function($scope,$rootScope,$stateParams,example1Service, $modal){
    ...
    $scope.getAllTableData = function(){
        ...
        example1Service.fetchTableData(params).then(function(ret){
