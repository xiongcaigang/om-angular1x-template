  ...
  .factory('$modalStack', ['$document', '$compile', '$rootScope', '$$stackedMap',
    function ($document, $compile, $rootScope, $$stackedMap) {
      ...
      $modalStack.open = function (modalInstance, modal) {
		...
		if(modal.customStyle != undefined) {
			angularDomEl.css("width", modal.customStyle.width);
			angularDomEl.css("height", modal.customStyle.height);
			angularDomEl.css("left", modal.customStyle.left);		
		}
